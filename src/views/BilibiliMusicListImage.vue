<template>
  ...
  <el-row :gutter="10">
    ...
    >
      <el-card
        class="max-w-[480px] h-[80px] relative cursor-pointer transition-all duration-300 overflow-hidden group"
        shadow="hover"
      >
        <el-tooltip
          :content="music"
        ...
        >
          <span
            class="text-sm line-clamp-2 relative z-10"
